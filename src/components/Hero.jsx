                        ...
                        <div className="flex flex-col gap-4 items-center lg:items-start">
                            ...
                            <div className="hero-btn flex flex-row items-center gap-4">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <a href="https://www.linkedin.com/in/ramzan-khaskheli-336a6218a/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 sm:w-12 sm:h-12 rounded-full border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-primary hover:text-white hover:border-primary transition-all duration-300">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
